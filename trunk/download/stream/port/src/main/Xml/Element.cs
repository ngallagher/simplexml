...
namespace SimpleFramework.Xml {
   /// <summary>
   /// The <c>Element</c> annotation is used to represent a field
   ...
   /// this will look for a suitable <c>Transform</c> for the type
   /// using the <c>Transformer</c>. For instance, all primitives
   ...
   /// for example, the <c>class</c> attribute is reserved by the
