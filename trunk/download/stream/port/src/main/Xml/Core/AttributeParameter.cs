#region License
//
// AttributeParameter.cs July 2009
//
...
namespace SimpleFramework.Xml.Core {
   /// <summary>
   /// The <c>AttributeParameter</c> represents a constructor
   ...
   class AttributeParameter : Parameter {
      ...
      /// <summary>
      /// Constructor for the <c>AttributeParameter</c> object.
      ...
      /// </param>
      public AttributeParameter(Constructor factory, Attribute value, int index) {
      ...
      /// </summary>
      private static class Contact : ParameterContact<Attribute>  {
         /// <summary>
