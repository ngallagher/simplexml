#region License
//
// ElementListParameter.cs July 2009
//
...
namespace SimpleFramework.Xml.Core {
   /// <summary>
   /// The <c>ElementListParameter</c> represents a constructor
   ...
   class ElementListParameter : Parameter {
      ...
      /// <summary>
      /// Constructor for the <c>ElementListParameter</c> object.
      ...
      /// </param>
      public ElementListParameter(Constructor factory, ElementList value, int index) {
      ...
      /// </summary>
      private static class Contact : ParameterContact<ElementList>  {
         /// <summary>
