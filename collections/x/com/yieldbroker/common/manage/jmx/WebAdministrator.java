...
/**
 * This provides a means of management for the host service via a web browser.
 * All controls exposed are JMX attributes or operations which allows various
 * components to be manipulated for management.
 * 
...
public class WebAdministrator {
	...
	public void start() {
		try {
			...
			adapterServer.setPort(config.getPort());
