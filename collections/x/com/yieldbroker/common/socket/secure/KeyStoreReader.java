...
/**
 * A key store reader is used to read a key store in order to create
 * a list of {@link javax.net.ssl.KeyManager} objects. These managers are
 * then used to create SSL sockets with the key store keys.
 * 
