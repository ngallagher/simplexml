...
/**
 * The <code>NewType</code> object is used to represent a type that
 * has not yet been created and needs to be added to the object
...
final class NewType implements Type {
   ...
   /**
    * Constructor for the <code>NewType</code> object. This is used
