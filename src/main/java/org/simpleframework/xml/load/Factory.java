...
abstract class Factory {
    ...
    * @return this returns an instance of the field type
    */         
   public Object getPrimitive(String text, Class type) throws Exception {        
    ...
    */
   protected Object getEnumeration(String text) throws Exception {
    ...
    * @throws Exception if the object could not be transformed
    */
   public String getText(Object source, Class type) throws Exception {
      if(type.isEnum()) {
