/*
 * VariantListLabel.java March 2011
 *
...
/**
 * The <code>VariantListLabel</code> acts as an adapter for an internal
 ...
 * 
 * @see org.simpleframework.xml.core.VariantList
 */
class VariantListLabel implements Label {
   ...
   /**
    * Constructor for the <code>VariantListLabel</code> object. This 
    ...
    */
   public VariantListLabel(Contact contact, VariantList variant, ElementList element) throws Exception {
   ...
   public Converter getConverter(Context context) throws Exception {
      ...
      return new CompositeVariantList(context, extractor, type);
   }
