...
public class CompositeTest extends ValidationTestCase {
   ...
   "<compositeObject>" +
   "   <interfaceEntry name='name.1' class='org.simpleframework.xml.load.CompositeTest$CompositeEntry'>value.1</interfaceEntry>" +
   "   <objectEntry name='name.2' class='org.simpleframework.xml.load.CompositeTest$CompositeEntry'>value.2</objectEntry>" +
   "   <interfaceList>" +
   "      <interfaceEntry name='a' class='org.simpleframework.xml.load.CompositeTest$CompositeEntry'>a</interfaceEntry>" +
   "      <interfaceEntry name='b' class='org.simpleframework.xml.load.CompositeTest$CompositeEntry'>b</interfaceEntry>" +
   "   </interfaceList>" +
   "   <objectList>" +
   "      <objectEntry name='a' class='org.simpleframework.xml.load.CompositeTest$CompositeEntry'>a</objectEntry>" +
