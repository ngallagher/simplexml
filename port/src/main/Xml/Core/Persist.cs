...
namespace SimpleFramework.Xml.Core {
   /// <summary>
   /// The <c>Persist</c> annotation is used to mark a method that
   ...
   /// single <c>Map</c> argument, it may throw an exception to
   /// terminate the serialization process if required.
   /// </summary>
   /// <seealso>
   /// SimpleFramework.Xml.Core.Complete
   /// </seealso>
