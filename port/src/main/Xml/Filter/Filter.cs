...
namespace SimpleFramework.Xml.Filter {
   /// <summary>
   /// The <c>Filter</c> object is used to provide replacement string
   ...
   /// and variable keys marked like <c>${example}</c>. When the XML
   ...
   public interface Filter {
      ...
      /// acts much like a the indexer method of the <c>Dictionary</c>
