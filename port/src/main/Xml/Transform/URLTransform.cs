...
/// <summary>
/// The <c>URLTransform</c> object is used to transform URL
...
class URLTransform : Transform<URL> {
   /// <summary>
   ...
   /// </summary>
   /// <param name="target">
   /// this is the string representation of the URL
   /// </param>
   /// <returns>
   /// this returns an appropriate instanced to be used
   /// </returns>
   public URL Read(String target) {
   ...
   /// </returns>
   public String Write(URL target) {
